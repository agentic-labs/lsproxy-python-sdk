...
```sh
npm install git+ssh://git@github.com:agentic-labs/lsproxy-python-sdk.git
```
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/agentic-labs/lsproxy-python-sdk/tree/main/src/_shims#readme)).
