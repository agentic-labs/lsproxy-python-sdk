...
__all__ = ["ReferenceListParams", "SymbolIdentifierPosition"]


class ReferenceListParams(TypedDict, total=False):
    symbol_identifier_position: Required[SymbolIdentifierPosition]
...
class SymbolIdentifierPosition(TypedDict, total=False):
